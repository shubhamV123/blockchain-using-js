function BlockChain() {
    ...
    this.newTransactions = []; //All of the new transactions that are created before they are placed into a block.
}
BlockChain.prototype.createNewBlock = function (nonce, previousBlockHash, hash) {
    ...
    const newBlock = {//new block inside of our BlockChain
        ...
        timestamp: Date.now(),
        transactions: this.newTransactions,//all of the new transactions or the pending transactions that have just been created into the new block 
    ...
    this.newTransactions = [];  //clear out the entire new transactions array so that we can start over for the next block and already stored in newBlock
